...
# - Added selector
#---------------------------------------------------------------------------
import xbmc,xbmcplugin,xbmcaddon,xbmcgui,urllib,urllib2,re,sys,os,time,socket,gzip,json
...
ADDON_FOLDER = xbmc.translatePath('special://home/addons/plugin.video.streamarmybeta')
