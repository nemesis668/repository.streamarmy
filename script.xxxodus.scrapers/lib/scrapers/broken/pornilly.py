...
base_domain  = 'https://www.mydirtyhobby.com'
...
def menu():
	...
	try:
		url = urlparse.urljoin(base_domain,'media')
		c = client.request(url)
		soup = BeautifulSoup(c, 'html5lib')
		content = soup.find_all('li', class_={'col-xs-12'})
		if ( not content ):
...
def content(url,searched=False):
	...
	try:
		c = client.request(url)
		soup = BeautifulSoup(c, 'html5lib')
		content = soup.find_all('div', class_={'panel panel-gradient'})
