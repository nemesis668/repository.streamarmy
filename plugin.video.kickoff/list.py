...
Background_Image    = xbmc.translatePath(os.path.join('special://home/addons/' + _addon_id_ + _images_, 'listbg.jpg'))
...
def List_Selected(self):
    ...
    if 'LIVE:' in Media_Link:
    ...
    elif 'http://www.livefootballol.me' in Media_Link:
        self.List.reset()
        ...
        if source == 0:
            try:
                ...
                quit()
            if 'rutube' in match:
                stream_url = urlresolver.HostedMediaFile(match).resolve()
                Show_List  =  xbmcgui.ListItem(Media_Title)
