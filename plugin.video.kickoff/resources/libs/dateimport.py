...
def DateCheck():
    ...
    try:
        ...
        if checkpin == 'EXPIRED':
            dialog.ok("[COLOR blue]Kick Off[/COLOR]","[COLOR red]Please visit [COLOR yellow]http://streamarmy.co.uk[COLOR red] to generate a Pin to access NeverWalkAlone Addon then enter it after clicking ok, This takes less than a minute and helps pay for servers!!\n[COLOR white]This is only required once every 4 hours[/COLOR]")
            string =''
